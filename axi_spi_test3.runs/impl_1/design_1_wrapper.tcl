namespace eval ::optrace {
  variable script "C:/verilog_matbi/axi_spi_test3/axi_spi_test3.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/verilog_matbi/axi_spi_test3/axi_spi_test3.cache/wt [current_project]
  set_property parent.project_path C:/verilog_matbi/axi_spi_test3/axi_spi_test3.xpr [current_project]
  set_property ip_output_repo C:/verilog_matbi/axi_spi_test3/axi_spi_test3.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/verilog_matbi/axi_spi_test3/axi_spi_test3.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/verilog_matbi/axi_spi_test3/axi_spi_test3.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/verilog_matbi/axi_spi_test3/axi_spi_test3.srcs/constrs_1/imports/Oscilloscope/Cora-Z7-07S-Master.xdc
