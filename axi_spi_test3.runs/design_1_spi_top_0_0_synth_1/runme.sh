...
HD_PWD='C:/verilog_matbi/axi_spi_test3/axi_spi_test3.runs/design_1_spi_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_spi_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_spi_top_0_0.tcl
